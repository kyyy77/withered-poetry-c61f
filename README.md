...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/withered-poetry-c61f#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/withered-poetry-c61f
```

A live public deployment of this template is available at [https://withered-poetry-c61f.templates.workers.dev](https://withered-poetry-c61f.templates.workers.dev)
